package com.kuaiyue.loader.bean;
...
public class SysConfig implements Serializable {
    ...
    private int downPoolSize;// 下载任务数量
    ...
    public int getDownPoolSize() {
        return downPoolSize;
    }

    public void setDownPoolSize(int downPoolSize) {
        this.downPoolSize = downPoolSize;
    }
